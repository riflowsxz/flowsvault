...
function DocsContent() {
      ...
      {sections.map((section) => {
        ...
        return (
          <button
            ...
            className={`flex w-full items-center gap-3 px-3 py-2.5 text-sm rounded-xl ${
              isActive
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background">
        <div className="container max-w-[1600px] mx-auto flex h-12 sm:h-14 md:h-16 lg:h-[72px] items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10">
          <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 lg:gap-3.5 min-w-0 flex-1">
            <Link href="/" className="flex items-center gap-2 sm:gap-2.5 hover:opacity-80 min-w-0">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                <span className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold truncate bg-gradient-to-r from-foreground via-foreground/90 to-foreground/70 bg-clip-text">{t('appName')}</span>
              </div>
            </Link>
          </div>
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 shrink-0">
            <LanguageSwitcher />
            <Link href="/">
              <Button variant="outline" size="icon" className="h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 lg:h-10 lg:w-10 hover:bg-primary/10 rounded-xl border-primary/20" title="Home">
                <Home className="h-3 w-3 sm:h-3.5 sm:w-3.5 md:h-4 md:w-4 lg:h-5 lg:w-5" />
              </Button>
            </Link>
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              <SheetTrigger asChild>
                <Button variant="outline" size="icon" className="lg:hidden h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 hover:bg-primary/10 rounded-xl border-primary/20">
          ...
          <div className="sticky top-20 space-y-4 lg:space-y-6">
            <div className="space-y-2 lg:space-y-3 p-4 rounded-2xl bg-muted border border-border">
              <div className="flex items-center gap-2 px-1">
                ...
                <h3 className="text-sm font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">API Reference</h3>
              </div>
              <SidebarNav />
            </div>
          </div>
                ...
                <div className="space-y-10">
                  ...
                  <div id="quickstart" className="space-y-4 sm:space-y-6">
                    ...
                    <div className="not-prose grid gap-3 sm:gap-4">
                      <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-border bg-card">
                        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground text-base sm:text-lg font-bold shrink-0">1</div>
                        <div className="flex-1 space-y-1 sm:space-y-2 min-w-0">
                          <p className="font-bold text-sm sm:text-base bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">{t('docsSignupStep')}</p>
                          <p className="text-xs sm:text-sm text-muted-foreground/90 leading-relaxed break-words">{t('docsSignupDesc')} {baseUrl}</p>
                        </div>
                      </div>
                      <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-border bg-card">
                        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground text-base sm:text-lg font-bold shrink-0">2</div>
                        <div className="flex-1 space-y-1 sm:space-y-2 min-w-0">
                          <p className="font-bold text-sm sm:text-base bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">{t('docsTokenStep')}</p>
                          <p className="text-xs sm:text-sm text-muted-foreground/90 leading-relaxed">{t('docsTokenDesc')}</p>
                        </div>
                      </div>
                      <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-border bg-card">
                        <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground text-base sm:text-lg font-bold shrink-0">3</div>
                        <div className="flex-1 space-y-1 sm:space-y-2 min-w-0">
                          <p className="font-bold text-sm sm:text-base bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">{t('docsUploadStep')}</p>
                          <p className="text-xs sm:text-sm text-muted-foreground/90 leading-relaxed">{t('docsUploadStepDesc')}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div id="baseurl" className="space-y-3 sm:space-y-4">
                    ...
                    <div className="not-prose">
                      <div className="p-4 sm:p-5 rounded-xl border border-primary/20 bg-primary/5 overflow-x-auto">
                        <code className="text-sm sm:text-base font-mono font-semibold text-primary break-all">{baseUrl}/api</code>
                      </div>
                    </div>
                  </div>
                  ...
                  <div id="format" className="space-y-3 sm:space-y-4">
                    ...
                    <div className="not-prose">
                      <div className="p-4 sm:p-5 rounded-xl border border-border bg-muted/40">
                        <code className="text-sm sm:text-base font-mono font-semibold text-foreground">{t('docsApplicationJson')}</code>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  -H 'Cookie: next-auth.session-token=YOUR_SESSION_TOKEN'`}
                ...
                <div className="not-prose">
                  <div className="flex gap-3 sm:gap-4 p-4 sm:p-6 rounded-2xl border border-amber-500/30 bg-amber-50 dark:bg-amber-950/30">
                    <div className="p-2 sm:p-2.5 rounded-xl bg-amber-100 dark:bg-amber-900/50 h-fit shrink-0">
                      <AlertTriangle className="h-5 w-5 sm:h-6 sm:w-6 text-amber-700 dark:text-amber-300" />
                    </div>
                    <div className="space-y-2 sm:space-y-3 min-w-0">
                      <h4 className="font-bold text-base sm:text-lg text-amber-900 dark:text-amber-100">{t('docsSecurityBestPractices')}</h4>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="rounded-xl bg-emerald-100 dark:bg-emerald-900 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-emerald-700 dark:text-emerald-300 border border-emerald-500/20">POST</span>
                    <code className="text-sm sm:text-base font-mono font-semibold break-all text-foreground/90">/api/upload</code>
                  </div>
                </div>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="bg-muted/70">
                            <th className="text-left py-3 sm:py-4 px-4 sm:px-5 font-bold whitespace-nowrap text-foreground">{t('docsParameter')}</th>
                            <th className="text-left py-3 sm:py-4 px-4 sm:px-5 font-bold text-foreground">{t('docsDescription')}</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-border/50">
                          <tr className="hover:bg-muted/50">
                            <td className="py-3 sm:py-4 px-4 sm:px-5 whitespace-nowrap">
                              <code className="text-sm bg-primary/10 text-primary px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono font-semibold border border-primary/20">file</code>
                            </td>
                            <td className="py-3 sm:py-4 px-4 sm:px-5 text-muted-foreground text-sm">{t('docsFileParam')}</td>
                          </tr>
                          <tr className="hover:bg-muted/50">
                            <td className="py-3 sm:py-4 px-4 sm:px-5 whitespace-nowrap">
                              <code className="text-sm bg-primary/10 text-primary px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono font-semibold border border-primary/20">expiresIn</code>
                            </td>
                            <td className="py-3 sm:py-4 px-4 sm:px-5 text-muted-foreground text-sm">{t('docsExpiresParam')}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <Tabs defaultValue="curl" className="w-full not-prose">
                    <TabsList className="h-auto w-full sm:w-auto flex flex-wrap gap-2 p-2 bg-muted rounded-xl relative z-10">
                      <TabsTrigger value="curl" className="text-xs sm:text-sm px-3 py-2 rounded-lg cursor-pointer">cURL</TabsTrigger>
                      <TabsTrigger value="javascript" className="text-xs sm:text-sm px-3 py-2 rounded-lg cursor-pointer">JavaScript</TabsTrigger>
                      <TabsTrigger value="python" className="text-xs sm:text-sm px-3 py-2 rounded-lg cursor-pointer">Python</TabsTrigger>
                      <TabsTrigger value="php" className="text-xs sm:text-sm px-3 py-2 rounded-lg cursor-pointer">PHP</TabsTrigger>
                      <TabsTrigger value="node" className="text-xs sm:text-sm px-3 py-2 rounded-lg cursor-pointer">Node.js</TabsTrigger>
                    </TabsList>
            ...
            {activeSection === 'download' && (
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <h2 className="text-xl sm:text-2xl font-semibold tracking-tight border-b pb-2">{t('docsEndpoint')}</h2>
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="rounded-xl bg-blue-100 dark:bg-blue-900 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-blue-700 dark:text-blue-300 border border-blue-500/20">GET</span>
                    <code className="text-sm sm:text-base font-mono font-semibold break-all text-foreground/90">/api/download/:id</code>
                  </div>
                </div>
            ...
            {activeSection === 'list' && (
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="rounded-xl bg-blue-100 dark:bg-blue-900 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-blue-700 dark:text-blue-300 border border-blue-500/20">GET</span>
                    <code className="text-sm sm:text-base font-mono font-semibold text-foreground/90">/api/files</code>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="rounded-2xl border border-border overflow-hidden">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b-2 border-border/50 bg-gradient-to-r from-muted/80 to-muted/60">
                          <th className="text-left py-3 sm:py-4 px-4 sm:px-5 font-bold whitespace-nowrap text-foreground">{t('docsParameter')}</th>
                          <th className="text-left py-3 sm:py-4 px-4 sm:px-5 font-bold text-foreground">{t('docsDescription')}</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr className="border-b border-border/50 hover:bg-muted/50">
                          <td className="py-3 sm:py-4 px-4 sm:px-5 whitespace-nowrap"><code className="text-sm bg-primary/10 text-primary px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono font-semibold border border-primary/20">page</code></td>
                          <td className="py-3 sm:py-4 px-4 sm:px-5 text-muted-foreground text-sm">{t('docsPageParam')}</td>
                        </tr>
                        <tr className="border-b border-border/50 hover:bg-muted/50">
                          <td className="py-3 sm:py-4 px-4 sm:px-5 whitespace-nowrap"><code className="text-sm bg-primary/10 text-primary px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono font-semibold border border-primary/20">limit</code></td>
                          <td className="py-3 sm:py-4 px-4 sm:px-5 text-muted-foreground text-sm">{t('docsLimitParam')}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
            ...
            {activeSection === 'delete' && (
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <h2 className="text-xl sm:text-2xl font-semibold tracking-tight border-b pb-2">{t('docsEndpoint')}</h2>
                  <div className="flex items-center gap-3 flex-wrap">
                    <span className="rounded-xl bg-red-100 dark:bg-red-900 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold text-red-700 dark:text-red-300 border border-red-500/20">DELETE</span>
                    <code className="text-sm sm:text-base font-mono font-semibold break-all text-foreground/90">/api/files/:id</code>
                  </div>
                </div>
...
(async () => {
  try {
    ...
    process.exit(1);
                ...
                <div className="p-4 sm:p-5 rounded-2xl border border-red-500/30 bg-red-50 dark:bg-red-950/30">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-base sm:text-lg text-red-900 dark:text-red-100 mb-2">{t('docsWarning')}</h4>
                      <p className="text-sm sm:text-base text-red-800 dark:text-red-200 leading-relaxed">{t('docsDeleteWarning')}</p>
                    </div>
                  </div>
                </div>
              </div>
  ...
  "error": "Error message description"
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-green-500/20 bg-green-50/50 dark:bg-green-950/20">
                      <span className="rounded-xl bg-green-100 dark:bg-green-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-green-700 dark:text-green-300 h-fit shrink-0">200</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">OK</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus200')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-yellow-500/20 bg-yellow-50/50 dark:bg-yellow-950/20">
                      <span className="rounded-xl bg-yellow-100 dark:bg-yellow-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-yellow-700 dark:text-yellow-300 h-fit shrink-0">400</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus400')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus400Desc')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-orange-500/20 bg-orange-50/50 dark:bg-orange-950/20">
                      <span className="rounded-xl bg-orange-100 dark:bg-orange-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-orange-700 dark:text-orange-300 h-fit shrink-0">401</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus401')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus401Desc')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-red-500/20 bg-red-50/50 dark:bg-red-950/20">
                      <span className="rounded-xl bg-red-100 dark:bg-red-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-red-700 dark:text-red-300 h-fit shrink-0">404</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus404')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus404Desc')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-red-500/20 bg-red-50/50 dark:bg-red-950/20">
                      <span className="rounded-xl bg-red-100 dark:bg-red-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-red-700 dark:text-red-300 h-fit shrink-0">413</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus413')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus413Desc')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-purple-500/20 bg-purple-50/50 dark:bg-purple-950/20">
                      <span className="rounded-xl bg-purple-100 dark:bg-purple-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-purple-700 dark:text-purple-300 h-fit shrink-0">429</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus429')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus429Desc')}</p>
                      </div>
                    </div>
                    <div className="flex gap-3 sm:gap-4 p-4 sm:p-5 rounded-2xl border border-gray-500/20 bg-gray-50/50 dark:bg-gray-950/20">
                      <span className="rounded-xl bg-gray-100 dark:bg-gray-900 px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base font-bold text-gray-700 dark:text-gray-300 h-fit shrink-0">500</span>
                      <div className="min-w-0">
                        <p className="font-bold text-base sm:text-lg mb-1">{t('docsStatus500')}</p>
                        <p className="text-sm sm:text-base text-muted-foreground/90">{t('docsStatus500Desc')}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid gap-4 sm:gap-5 grid-cols-1 sm:grid-cols-2">
                    <div className="p-5 sm:p-6 rounded-2xl border border-border bg-card">
                      <h4 className="font-bold mb-2 text-sm sm:text-base text-foreground/80">{t('docsUploadLimit')}</h4>
                      <p className="text-3xl sm:text-4xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">10</p>
                      <p className="text-xs sm:text-sm text-muted-foreground font-medium">{t('docsRequestsPerMin')}</p>
                    </div>
                    <div className="p-5 sm:p-6 rounded-2xl border border-border bg-card">
                      <h4 className="font-bold mb-2 text-sm sm:text-base text-foreground/80">{t('docsDownloadLimit')}</h4>
                      <p className="text-3xl sm:text-4xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">50</p>
                      <p className="text-xs sm:text-sm text-muted-foreground font-medium">{t('docsRequestsPerMin')}</p>
                    </div>
                    <div className="p-5 sm:p-6 rounded-2xl border border-border bg-card">
                      <h4 className="font-bold mb-2 text-sm sm:text-base text-foreground/80">{t('docsListLimit')}</h4>
                      <p className="text-3xl sm:text-4xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">30</p>
                      <p className="text-xs sm:text-sm text-muted-foreground font-medium">{t('docsRequestsPerMin')}</p>
                    </div>
                    <div className="p-5 sm:p-6 rounded-2xl border border-border bg-card">
                      <h4 className="font-bold mb-2 text-sm sm:text-base text-foreground/80">{t('docsDeleteLimit')}</h4>
                      <p className="text-3xl sm:text-4xl font-bold mb-2 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">20</p>
                      <p className="text-xs sm:text-sm text-muted-foreground font-medium">{t('docsRequestsPerMin')}</p>
                    </div>
                  </div>
                </div>
...
X-RateLimit-Reset: 1698156000`}
                ...
                <div className="p-4 sm:p-5 rounded-2xl border border-blue-500/30 bg-blue-50 dark:bg-blue-950/30">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="p-2 rounded-xl bg-blue-100 dark:bg-blue-900/50 shrink-0">
                      <Zap className="h-5 w-5 text-blue-700 dark:text-blue-300" />
                    </div>
                    <h4 className="font-bold text-base sm:text-lg text-blue-900 dark:text-blue-100">{t('docsBestPractices')}</h4>
                  </div>
                  <ul className="text-sm sm:text-base text-blue-800 dark:text-blue-200 space-y-1.5 sm:space-y-2 list-disc list-inside ml-1">
      ...
      <footer className="border-t border-border bg-muted/20 mt-12 sm:mt-16 md:mt-20">
        <div className="container max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-8 sm:py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
            <p className="text-sm sm:text-base text-muted-foreground/90 text-center md:text-left font-medium">
              {t('docsNeedHelp')}
            </p>
            <div className="flex items-center gap-4 sm:gap-6">
              <Link href="/" className="text-sm sm:text-base text-muted-foreground hover:text-primary font-medium">
                {t('docsHome')}
              </Link>
              <span className="text-muted-foreground/30">•</span>
              <Link href="/docs" className="text-sm sm:text-base text-muted-foreground hover:text-primary font-medium">
                {t('docsDocumentation')}
              </Link>
            </div>
          </div>
